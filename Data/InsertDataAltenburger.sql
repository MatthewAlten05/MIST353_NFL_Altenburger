...
IF OBJECT_ID('AdminChangesTracker') IS NOT NULL DELETE FROM AdminChangesTracker;
IF OBJECT_ID('Game') IS NOT NULL DELETE FROM Game;
IF OBJECT_ID('TeamStadium') IS NOT NULL DELETE FROM TeamStadium;
...
IF OBJECT_ID('Stadium') IS NOT NULL DELETE FROM Stadium;
...
IF OBJECT_ID('Stadium') IS NOT NULL DBCC CHECKIDENT ('Stadium', RESEED, 0);
IF OBJECT_ID('TeamStadium') IS NOT NULL DBCC CHECKIDENT ('TeamStadium', RESEED, 0);
IF OBJECT_ID('Game') IS NOT NULL DBCC CHECKIDENT ('Game', RESEED, 0);
IF OBJECT_ID('AdminChangesTracker') IS NOT NULL DBCC CHECKIDENT ('AdminChangesTracker', RESEED, 0);
...
SELECT AppUserID FROM AppUser WHERE UserRole = N'NFLFan';

INSERT INTO NFLAdmin (NFLAdminID)
SELECT AppUserID FROM AppUser WHERE UserRole = N'NFLAdmin';
...
IF OBJECT_ID('Stadium') IS NOT NULL SELECT * FROM Stadium;
IF OBJECT_ID('TeamStadium') IS NOT NULL SELECT * FROM TeamStadium;